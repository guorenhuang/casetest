...
exam-wangxing/
  ...
  README.md                   # 本文件：总入口
  TRANSCRIPT.md               # 全卷 transcript 说明：公共部分 vs 各题、与 chat.html 的关系
  agent0_transcript.md        # 公共部分 AI 协同（exam-libraries / index.html / chat.html 等），非某一单题
...
端口：**Q1 → 8001**，**Q3 → 8765**，**Q2 → 8009**，**Q4 → 8004**。仅保留本目录 `docker-compose.yml` 编排四题；开发时请先 `cd` 到 **`exam-wangxing`**。
